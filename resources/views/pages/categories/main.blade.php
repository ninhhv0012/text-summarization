...
<div class="content d-flex flex-column flex-column-fluid" id="kt_content">
    ...
    <div class="post d-flex flex-column-fluid" id="kt_post">
        ...
        <div id="kt_content_container" class="container-xxl">
                ...
                <div class="card-header border-0 pt-6">
                    ...
                    <div class="card-title">
                        ...
                        <div class="d-flex align-items-center position-relative my-1">
                            ...
                            <!--end::Svg Icon-->
                            <input type="text" id="search_table" class="form-control form-control-solid w-250px ps-15" placeholder="Search Categories" />
                        </div>
                        <!--end::Search-->
                    </div>
                    <!--begin::Card title-1-->
                    ...
                    <div class="card-toolbar">
                        ...
                        <div class="d-flex justify-content-end" data-kt-customer-table-toolbar="base">
                            ...
                            <div class="menu menu-sub menu-sub-dropdown w-300px w-md-325px modal-filter"
                                ...
                                <form id="filter_form">
                                    <div class="px-7 py-5">
                                        ...
                                        <div class="mb-10">
                                            <!--begin::Label-->
                                            <label class="form-label fs-5 fw-bold mb-3">Activation:</label>
                                            <!--end::Label-->
                                            <!--begin::Input-->
                            ...
                            <!--end::Filter-->
                            <!--begin::Add customer-->
                            <button type="button" class="btn btn-primary" id="add_modal">Add Category</button>
                    ...
                    <table class="table align-middle table-row-dashed fs-6 gy-5" id="kt_customers_table">
                        ...
                        <thead>
                            ...
                            <tr class="text-start text-gray-400 fw-bolder fs-7 text-uppercase gs-0">
                                ...
                                <th class="min-w-125px min-w-[5remn] text-align: center;">Activation</th>
            ...
            <!--end::Card-->
            <!--begin::Modals-->
            @include('pages.categories.modal')
